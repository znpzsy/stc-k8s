(function () {
    ...
    SubsystemsConstants.constant('REPORTING_MSGGW_REPORT_CHANNELS', ['SMS', 'MMS']);
    ...
    SubsystemsConstants.constant('CMS_ACCESS_CHANNELS', ["IVR", "USSD", "SMS", "RBTMobileApp", "RBTSubscriberPortal", "MobilyMobileApp", "MobilyEPortal", "OTHER"]);
    ...
    SubsystemsConstants.constant('CMS_RBT_STATUS_TYPES', ['PENDING', 'ACTIVE', 'HIDDEN', 'INACTIVE']);
