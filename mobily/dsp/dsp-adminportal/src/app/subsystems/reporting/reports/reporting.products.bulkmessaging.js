(function () {
    ...
    ReportingReportsBulkMessagingModule.controller('ReportingReportsBulkMessagingCtrl', function ($rootScope, $scope, $log, $controller, $filter, UtilService, Restangular, SessionService, CMPFService,
        ...
        // SMS
        var BMS_SMS_Traffic_Summary_Report = UtilService.defineReportsAsDHM(':home:csp:BMS:BMS_SMS_Traffic_Summary_Report.prpt');
        var BMS_SMS_Campaign_Summary_Report = UtilService.defineReportsAsAll(':home:csp:BMS:BMS_SMS_Campaign_Summary_Report.prpt');
        ...
        var BMS_SMS_Interactive_Campaign_Report = UtilService.defineReportsAsAll(':home:csp:BMS:BMS_SMS_Interactive_Campaign_Report.prpt');

        // MMS
        var BMS_MMS_Traffic_Summary_Report = UtilService.defineReportsAsDHM(':home:csp:BMS:BMS_MMS_Traffic_Summary_Report.prpt');
        var BMS_MMS_Campaign_Summary_Report = UtilService.defineReportsAsAll(':home:csp:BMS:BMS_MMS_Campaign_Summary_Report.prpt');
        ...
        // IVR
        var BMS_IVR_Traffic_Summary_Report = UtilService.defineReportsAsDHM(':home:csp:BMS:BMS_IVR_Traffic_Summary_Report.prpt');
        var BMS_IVR_Campaign_Summary_Report = UtilService.defineReportsAsAll(':home:csp:BMS:BMS_IVR_Campaign_Summary_Report.prpt');
        var BMS_IVR_Campaign_Detail_By_Organization_Report = UtilService.defineReportsAsAll(':home:csp:BMS:BMS_IVR_Campaign_Detail_By_Organization_Report.prpt');
        var BMS_IVR_Campaign_Detail_By_User_Report = UtilService.defineReportsAsAll(':home:csp:BMS:BMS_IVR_Campaign_Detail_By_User_Report.prpt');
        var BMS_IVR_Interactive_Campaign_Report = UtilService.defineReportsAsAll(':home:csp:BMS:BMS_IVR_Interactive_Campaign_Report.prpt');
        // Fastkey
        var FKCM_HLR_Forwarding_Report = UtilService.defineReportsAsAll(':home:csp:FKCM:FKCM_HLR_Forwarding_Report.prpt');
        var FKCM_Play_by_SingleTone_Report = UtilService.defineReportsAsAll(':home:csp:FKCM:FKCM_Play_by_SingleTone_Report.prpt');
        var FKCM_TotalPlay_Report = UtilService.defineReportsAsAll(':home:csp:FKCM:FKCM_TotalPlay_Report.prpt');
        ...
        var REPORTS = {
            'Bulk SMS': [
                ...
                {
                    group: 'Campaign Reports',
                    label: 'BMS SMS Campaign Detail Report',
            ...
            'Bulk IVR': [
                ...
                // RBT Fast-Key Reports
                {
                    group: 'RBT Fast-Key Reports',
                    label: 'Ring Back Tone Fast-Key Total Play Report',
                    intervals: FKCM_TotalPlay_Report
                },
                {
                    group: 'RBT Fast-Key Reports',
                    label: 'Ring Back Tone Fast-Key HLR Forwarding Report',
                    intervals: FKCM_HLR_Forwarding_Report
                },
                {
                    group: 'RBT Fast-Key Reports',
                    label: 'Ring Back Tone Fast-Key Play by Single Tone Report',
                    intervals: FKCM_Play_by_SingleTone_Report,
