(function () {
    ...
    angular.module('adminportal.subsystems.provisioning.operations.services.templates', []);

    var ProvisioningOperationsServicesTemplatesModule = angular.module('adminportal.subsystems.provisioning.operations.services.templates');

    ProvisioningOperationsServicesTemplatesModule.controller('ProvisioningOperationsServicesTemplatesCtrl', function ($scope, $log, $uibModal) {
        $log.debug('ProvisioningOperationsServicesTemplatesCtrl');

        var templateProfiles = {
            'ALERTS': {
                templateUrl: 'subsystems/provisioning/operations/services/operations.services.modal.alerttemplate.html',
                controller: 'ProvisioningOperationsServicesTemplatesAlertsModalInstanceCtrl'
            },
            'ON_DEMAND': {
                templateUrl: 'subsystems/provisioning/operations/services/operations.services.modal.ondemandtemplate.html',
                controller: 'ProvisioningOperationsServicesTemplatesOnDemandModalInstanceCtrl'
            },
            'OTHER': {
                templateUrl: 'subsystems/provisioning/operations/services/operations.services.modal.othertemplate.html',
                controller: 'ProvisioningOperationsServicesTemplatesOtherModalInstanceCtrl'
            },
            'SEQUENTIAL': {
                templateUrl: 'subsystems/provisioning/operations/services/operations.services.modal.alerttemplate.html',
                controller: 'ProvisioningOperationsServicesTemplatesAlertsModalInstanceCtrl'
    ...
    ProvisioningOperationsServicesTemplatesModule.controller('ProvisioningOperationsServicesTemplatesCommonCtrl', function ($scope, $log, $uibModal, $uibModalInstance, SERVICE_ALERT_SCHEDULING_TYPES, SERVICE_CYCLE_PERIODS,
                                                                                                                            DAYS_OF_WEEK) {
        $log.debug('ProvisioningOperationsServicesTemplatesCommonCtrl');
    ...
    ProvisioningOperationsServicesTemplatesModule.controller('ProvisioningOperationsServicesTemplatesAlertsModalInstanceCtrl', function ($scope, $log, $controller, $filter, $uibModalInstance, UtilService, service, itemName,
                                                                                                                                         templateAttributes) {
        $log.debug('ProvisioningOperationsServicesTemplatesAlertsModalInstanceCtrl');

        $controller('ProvisioningOperationsServicesTemplatesCommonCtrl', {
            $scope: $scope,
    ...
    ProvisioningOperationsServicesTemplatesModule.controller('ProvisioningOperationsServicesTemplatesOnDemandModalInstanceCtrl', function ($scope, $log, $controller, $uibModalInstance, service, itemName, templateAttributes) {
        $log.debug('ProvisioningOperationsServicesTemplatesOnDemandModalInstanceCtrl');
    ...
    ProvisioningOperationsServicesTemplatesModule.controller('ProvisioningOperationsServicesTemplatesOtherModalInstanceCtrl', function ($scope, $log, $controller, $uibModalInstance, service, itemName, templateAttributes) {
        $log.debug('ProvisioningOperationsServicesTemplatesOtherModalInstanceCtrl');
