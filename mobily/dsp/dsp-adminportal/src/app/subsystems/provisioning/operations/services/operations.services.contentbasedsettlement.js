(function () {
    ...
    angular.module('adminportal.subsystems.provisioning.operations.services.contentbasedsettlement', []);

    var ProvisioningOperationsServiceContentBasedSettlementProfileModule = angular.module('adminportal.subsystems.provisioning.operations.services.contentbasedsettlement');

    ProvisioningOperationsServiceContentBasedSettlementProfileModule.controller('ProvisioningOperationsServiceContentBasedSettlementProfileCtrl', function ($scope, $log, $uibModal) {
        $log.debug('ProvisioningOperationsServiceContentBasedSettlementProfileCtrl');
        ...
        $scope.addServiceContentBasedSettlementProfile = function (service) {
            var modalInstance = $uibModal.open({
                templateUrl: 'subsystems/provisioning/operations/services/operations.services.modal.contentbasedsettlement.html',
