(function () {
    ...
    angular.module('adminportal.subsystems.provisioning.operations.services.servicecapabilityaccess', []);

    var ProvisioningOperationsServiceCapabilityAccessModule = angular.module('adminportal.subsystems.provisioning.operations.services.servicecapabilityaccess');

    ProvisioningOperationsServiceCapabilityAccessModule.controller('ProvisioningOperationsServiceCapabilityAccessCtrl', function ($scope, $log, $uibModal) {
        $log.debug('ProvisioningOperationsServiceCapabilityAccessCtrl');

        // ServiceCapabilityAccessProfiles managing methods.
        $scope.addServiceCapabilityAccessProfile = function (service) {
            var modalInstance = $uibModal.open({
                templateUrl: 'subsystems/provisioning/operations/services/operations.services.modal.servicecapabilityaccess.html',
