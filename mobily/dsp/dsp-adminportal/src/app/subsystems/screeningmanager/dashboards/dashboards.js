(function () {
    ...
    ScreeningmanagerDashboardsModule.controller('ScreeningmanagerDashboardsCtrl', function ($scope, $log, $interval, $filter, ScreeningManagerV3Service,
        ...
        var getScreenings = function (promiseTracker) {
            ScreeningManagerV3Service.getScreenings(promiseTracker).then(function (response) {
                $log.debug('Success. Response: ', response);
        ...
        var getSubscribers = function (promiseTracker) {
            ScreeningManagerV3Service.getSubscribers(promiseTracker).then(function (response) {
                $log.debug('Success. Response: ', response);
        ...
        var getConstraints = function (promiseTracker) {
            ScreeningManagerV3Service.getConstraints(promiseTracker).then(function (response) {
                $log.debug('Success. Response: ', response);
