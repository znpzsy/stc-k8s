(function () {
    ...
    /* Idle Service */
    angular.module('adminportal.idleservice', []);

    var IdleServiceModule = angular.module('adminportal.idleservice');
    ...
    IdleServiceModule.factory('IdleServiceFactory', function ($rootScope, $log, $window, $timeout, $interval, $uibModal, Idle, Keepalive, IdleConfService, SessionService,
