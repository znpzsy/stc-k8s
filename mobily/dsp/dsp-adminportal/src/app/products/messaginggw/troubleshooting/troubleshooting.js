(function () {
    ...
    angular.module('adminportal.products.messaginggw.troubleshooting', []);

    var MessagingGwTroubleshootingModule = angular.module('adminportal.products.messaginggw.troubleshooting');

    MessagingGwTroubleshootingModule.config(function ($stateProvider) {

        $stateProvider.state('products.messaginggw.troubleshooting', {
            abstract: true,
            url: "/troubleshooting",
            templateUrl: "products/messaginggw/troubleshooting/troubleshooting.html",
            data: {
                permissions: [
                    'ALL__TROUBLESHOOTING_READ'
                ]
            }
        }).state('products.messaginggw.troubleshooting.sms', {
            url: "/sms",
            views: {
                'filter-form': {
                    templateUrl: 'products/messaginggw/troubleshooting/troubleshooting.sms.filter.html',
                },
                'table': {
                    templateUrl: 'products/messaginggw/troubleshooting/troubleshooting.sms.html',
        ...
        }).state('products.messaginggw.troubleshooting.mms', {
            url: "/mms",
            views: {
                'filter-form': {
                    templateUrl: 'products/messaginggw/troubleshooting/troubleshooting.mms.filter.html',
                },
                'table': {
                    templateUrl: 'products/messaginggw/troubleshooting/troubleshooting.mms.html',
    ...
    MessagingGwTroubleshootingModule.controller('MessagingGwTroubleshootingSMSCtrl', function ($scope, $log, $q, $filter, $controller, notification, $translate, $uibModal, Restangular, NgTableParams,
        ...
        $scope.showDetails = function (edrRecord) {
            $scope.showDetailsCommon(edrRecord, 'products/messaginggw/troubleshooting/troubleshooting.sms.edr.details.html');
        };
        ...
        $scope.showMessageContent = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/messaginggw/troubleshooting/troubleshooting.sms.edr.messagecontent.html',
        ...
        $scope.showMessageDeliveryReport = function (edrRecord) {
            $scope.showMessageDeliveryReportCommon(edrRecord, 'products/messaginggw/troubleshooting/troubleshooting.sms.edr.messagedeliveryreport.html', GeneralESService.findMessagingGwSMSDeliveryReports);
        };
    });
    ...
    MessagingGwTroubleshootingModule.controller('MessagingGwTroubleshootingMMSCtrl', function ($scope, $log, $q, $filter, $controller, notification, $translate, $uibModal, Restangular, NgTableParams,
        ...
        // Show details.
        $scope.showDetails = function (edrRecord) {
            $scope.showDetailsCommon(edrRecord, 'products/messaginggw/troubleshooting/troubleshooting.mms.edr.details.html');
        };

        // Show message delivery report.
        $scope.showMessageDeliveryReport = function (edrRecord) {
            $scope.showMessageDeliveryReportCommon(edrRecord, 'products/messaginggw/troubleshooting/troubleshooting.mms.edr.messagedeliveryreport.html', GeneralESService.findMessagingGwMMSDeliveryReports);
        };
    });
