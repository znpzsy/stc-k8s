...
var applicationName = 'dsp-ccportal';
...
gulp.task('usemin-main', ['clean', 'config'], function () {
    return gulp.src(bases.src + '/*.html')
        .pipe(usemin({
            ...
            css_sso: [nano({zindex: false}), rev()],
            libjs: [ngAnnotate(), uglify(uglifyOptions), rev()],
            libjs_small: [ngAnnotate(), uglify(uglifyOptions), rev()],
            libjs_sso: [ngAnnotate(), uglify(uglifyOptions), rev()],
            index_js: [ngAnnotate(), uglify(uglifyOptions), rev()],
            app_js: [ngAnnotate(), uglify(uglifyOptions), rev()],
            app_js_sso: [ngAnnotate(), uglify(uglifyOptions), rev()],
            app_js_other: [ngAnnotate(), uglify(uglifyOptions), rev()],
            app_js_other_sso: [ngAnnotate(), uglify(uglifyOptions), rev()]
        }))
