(function () {
    ...
    angular.module('ccportal.subscriber-info.subscriptions.serviceoffers', []);

    var SISubscriptionsServiceOffersModule = angular.module('ccportal.subscriber-info.subscriptions.serviceoffers');

    SISubscriptionsServiceOffersModule.config(function ($stateProvider) {

        $stateProvider.state('subscriber-info.subscriptions.serviceoffers', {
            url: "/subscribed-service-offers",
            templateUrl: 'subscriber-info/subscriptions/subscriptions.serviceoffers.html',
    ...
    SISubscriptionsServiceOffersModule.controller('SISubscriptionsServiceOffersBaseCtrl', function ($scope, $log, $q, $state, $timeout, $filter, $translate, $uibModal, NgTableService, UtilService, SessionService,
        ...
        var subscribeConfirmation = function (msisdn, offer, isSubscribe) {
            ...
            modalInstance.result.then(function () {
                ...
                if ((offer.subscription && offer.subscription.isRbt) || offer.xsmOfferProfile.IsRbt) {
                    ...
                    createOfferSubscriptionProm = SSMSubscribersService.createSubscription(msisdn, subscriptionItem);
                }
        ...
        var unsubscribeConfirmation = function (msisdn, offer) {
            ...
            modalInstance.result.then(function () {
                ...
                if ((offer.subscription && offer.subscription.isRbt) || offer.xsmOfferProfile.IsRbt) {
                    ...
                    updatePromise = SSMSubscribersService.updateSubscription(msisdn, stateItem);
                }
        ...
        var prepareCMPFOffers = function (from, size, text) {
            ...
            CMPFService.getOffers(from, size, false, false, false, null, null, text).then(function (offers) {
