(function () {
    ...
    angular.module('ccportal.subscriber-info.subscriptions.contentoffers', []);

    var SISubscriptionsContentOffersModule = angular.module('ccportal.subscriber-info.subscriptions.contentoffers');

    SISubscriptionsContentOffersModule.config(function ($stateProvider) {

        $stateProvider.state('subscriber-info.subscriptions.contentoffers', {
            url: "/subscribed-content-offers",
            templateUrl: 'subscriber-info/subscriptions/subscriptions.contentoffers.html',
