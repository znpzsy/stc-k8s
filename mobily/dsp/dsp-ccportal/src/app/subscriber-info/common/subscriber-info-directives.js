(function () {
    ...
    var SubscriberInfoDirectives = angular.module('ccportal.subscriber-info.directives');

    SubscriberInfoDirectives.directive('availablityCheck', function () {
        return {
    ...
    SubscriberInfoDirectives.directive('subscribersNumberCheck', function () {
        return {
            // restrict to an attribute type.
            restrict: 'A',
            // element must have ng-model attribute.
