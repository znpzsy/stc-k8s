(function () {
    ...
    angular.module('ccportal.subscriber-info.activityhistory.subscriptionhistory.contentsubscription', []);

    var ActivityHistoryContentSubscriptionHistoryModule = angular.module('ccportal.subscriber-info.activityhistory.subscriptionhistory.contentsubscription');

    ActivityHistoryContentSubscriptionHistoryModule.config(function ($stateProvider) {

        $stateProvider.state('subscriber-info.activityhistory.subscriptionhistory.contentsubscription', {
            url: "/content-subscription",
            templateUrl: "subscriber-info/activity-history/subscriptionhistory/csm-subscriptionhistory.html",
