(function () {
    ...
    angular.module('partnerportal.partner-info.services.servicecopyrightfile', []);

    var ProvisioningOperationsServiceCopyrightFileModule = angular.module('partnerportal.partner-info.services.servicecopyrightfile');

    ProvisioningOperationsServiceCopyrightFileModule.controller('PartnerInfoServiceCopyrightFileCtrl', function ($scope, $log, $uibModal, $filter, DateTimeConstants) {
        $log.debug('PartnerInfoServiceCopyrightFileCtrl');

        // ServiceCopyrightFileProfiles managing methods.
        $scope.addServiceCopyrightFileProfile = function (service) {
            var modalInstance = $uibModal.open({
                templateUrl: 'partner-info/services/operations.services.modal.servicecopyrightfile.html',
