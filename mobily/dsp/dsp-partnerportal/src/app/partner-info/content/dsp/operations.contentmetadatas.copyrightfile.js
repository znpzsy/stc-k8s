(function () {
    ...
    angular.module('partnerportal.partner-info.operations.dsp.contentmetadatas.copyrightfile', []);

    var PartnerInfoContentManagementContentMetadatasCopyrightFileModule = angular.module('partnerportal.partner-info.operations.dsp.contentmetadatas.copyrightfile');

    PartnerInfoContentManagementContentMetadatasCopyrightFileModule.controller('PartnerInfoContentManagementContentMetadatasCopyrightFileCtrl', function ($scope, $log, $uibModal, $filter, DateTimeConstants) {
        $log.debug('PartnerInfoContentManagementContentMetadatasCopyrightFileCtrl');

        // CopyrightFiles managing methods.
        $scope.addCopyrightFile = function (contentMetadata) {
            var modalInstance = $uibModal.open({
                templateUrl: 'partner-info/content/dsp/operations.contentmetadatas.copyrightfile.modal.html',
