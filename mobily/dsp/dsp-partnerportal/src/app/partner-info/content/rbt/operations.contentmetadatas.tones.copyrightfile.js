(function () {
    ...
    angular.module('partnerportal.partner-info.operations.rbt.contentmetadatas.tones.copyrightfile', []);

    var PartnerInfoContentManagementContentMetadatasRBTTonesCopyrightFileModule = angular.module('partnerportal.partner-info.operations.rbt.contentmetadatas.tones.copyrightfile');

    PartnerInfoContentManagementContentMetadatasRBTTonesCopyrightFileModule.controller('PartnerInfoContentManagementContentMetadatasRBTTonesCopyrightFileCtrl', function ($scope, $log, $uibModal, $filter, DateTimeConstants) {
        $log.debug('PartnerInfoContentManagementContentMetadatasRBTTonesCopyrightFileCtrl');

        // CopyrightFiles managing methods.
        $scope.addCopyrightFile = function (contentMetadata) {
            var modalInstance = $uibModal.open({
                templateUrl: 'partner-info/content/rbt/operations.contentmetadatas.tones.copyrightfile.modal.html',
