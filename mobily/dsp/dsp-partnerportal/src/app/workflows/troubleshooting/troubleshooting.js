(function () {
    ...
    angular.module('partnerportal.workflows.troubleshooting', []);

    var WorkflowsTroubleshootingModule = angular.module('partnerportal.workflows.troubleshooting');
    ...
    WorkflowsTroubleshootingModule.controller('WorkflowsTroubleshootingCtrl', function ($scope, $log, $controller, $timeout, $filter, $uibModal, Restangular, UtilService, DateTimeConstants,
                                                                                        SessionService, GeneralESService, ReportingExportService, services, userAccounts, WORKFLOWS_RESOURCE_TYPES,
        ...
        $scope.prepareFilter = function (dateFilter, tableParams) {
            ...
            if (dateFilter.resourceType !== 'PARTNER') {
                result.additionalFilterFields.resourceId = dateFilter.resourceId;
            }
        ...
        $scope.showPayload = function (edrRecord) {
            $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance, edrRecord, payload) {
                    ...
                    } else if (edrRecord.resourceType === 'INTERACTIVE_CAMPAIGN_IVR') {
