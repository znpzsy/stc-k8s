    ...
    ApplicationAuthorizationServices.factory('AuthorizationService', function ($q, $log, UtilService, CMPFService, Restangular, RESOURCE_NAME) {
        return {
            ...
            permissions: {
                ...
                // Tone
                RBT__TONE_CREATE: "RBT::Tone:Create",
                RBT__TONE_READ: "RBT::Tone:Read",
                RBT__TONE_UPDATE: "RBT::Tone:Update",
                RBT__TONE_DELETE: "RBT::Tone:Delete",
            ...
            canRBTToneUpdate: function (state) {
                return state !== 'PENDING' && this.canDo(this.permissions.RBT__TONE_UPDATE);
            },
