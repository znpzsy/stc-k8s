...
mainApp.set('trust proxy', 'loopback') // trust first proxy
...
_.each(serverConfig.applications, function (application) {
    ...
    var options = {
        proxyTimeout: 6000000, // Timeout is 2 minutes.
        timeout: 600000, // Timeout is 2 minutes.
    ...
    var applicationProxy = new Proxy(application.path, options);

    mainApp.use(applicationProxy)
});
