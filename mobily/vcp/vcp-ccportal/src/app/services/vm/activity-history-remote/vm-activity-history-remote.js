(function () {
    ...
    angular.module('ccportal.services.vm.activity-history-remote', []);

    var VMActivityHistoryRemoteModule = angular.module('ccportal.services.vm.activity-history-remote');

    VMActivityHistoryRemoteModule.config(function ($stateProvider) {

        $stateProvider.state('services.vm.activity-history-remote', {
            url: "/activity-history-remote",
            templateUrl: "services/vm/activity-history/vm-activity-history.html",
            controller: 'VMActivityHistoryRemoteCtrl'
        });

    });

    VMActivityHistoryRemoteModule.controller('VMActivityHistoryRemoteCtrl', function ($scope, $log, $controller, $timeout, $filter, UtilService, DateTimeConstants) {
        $log.debug('VMActivityHistoryRemoteCtrl');
        ...
        $controller('VMActivityHistoryRemoteTableCtrl', {$scope: $scope});
        $controller('VMActivityHistoryRemoteHistoryCtrl', {$scope: $scope});
    });

    VMActivityHistoryRemoteModule.controller('VMActivityHistoryRemoteTableCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams,
                                                                                           UtilService, GeneralESService, DateTimeConstants) {
        $log.debug('VMActivityHistoryRemoteTableCtrl');

        $scope.exportFileName = 'VoiceMailServiceActivityHistoryRecordsRemote';
    ...
    VMActivityHistoryRemoteModule.controller('VMActivityHistoryRemoteHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams,
                                                                                             GeneralESService, DateTimeConstants) {
        $log.debug('VMActivityHistoryRemoteHistoryCtrl');
