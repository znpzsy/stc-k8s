(function () {
    ...
    angular.module('ccportal.services.pokecall.activity-history', []);

    var PokeCallTroubleshootingModule = angular.module('ccportal.services.pokecall.activity-history');

    PokeCallTroubleshootingModule.config(function ($stateProvider) {

        $stateProvider.state('services.pokecall.activity-history', {
    ...
    PokeCallTroubleshootingModule.controller('PokeCallTroubleshootingTableCtrl', function ($scope, $log, $q, $filter, UtilService, NgTableParams, notification, $translate,
        ...
        $scope.exportFileName = 'PokeCallServiceActivityHistoryRecords';
