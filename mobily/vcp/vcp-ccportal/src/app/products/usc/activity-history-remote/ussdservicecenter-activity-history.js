(function () {
    ...
    angular.module('ccportal.products.usc.activity-history-remote', []);

    var USCActivityHistoryRemoteModule = angular.module('ccportal.products.usc.activity-history-remote');

    USCActivityHistoryRemoteModule.config(function ($stateProvider) {

        $stateProvider.state('products.usc.activity-history-remote', {
            url: "/activity-history-remote",
            templateUrl: "products/usc/activity-history/ussdservicecenter-activity-history.html",
            controller: 'USCActivityHistoryRemoteCtrl'
        });

    });

    USCActivityHistoryRemoteModule.controller('USCActivityHistoryRemoteCtrl', function ($scope, $log, $controller, $timeout, $filter, DateTimeConstants, Restangular,
        ...
        $controller('USCActivityHistoryRemoteTableCtrl', {$scope: $scope});
    });

    USCActivityHistoryRemoteModule.controller('USCActivityHistoryRemoteTableCtrl', function ($scope, $log, $filter, UtilService, NgTableParams, notification, $translate,
        ...
        $scope.exportOptions = {
            columns: [
                ...
                },
                {
                    ...
                    filter: {name: 'ServiceinitiatedFilter'}
                },
                {
                    fieldName: 'sessionId',
