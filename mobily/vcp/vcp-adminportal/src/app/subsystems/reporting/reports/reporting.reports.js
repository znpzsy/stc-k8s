(function () {
    ...
    angular.module('adminportal.subsystems.reporting.reports', [
        ...
        "adminportal.subsystems.reporting.reports.services.pokecall",
    ...
    ReportingReportsModule.controller('ReportingReportsAbstractCtrl', function ($scope, $log, $q, $timeout, $controller, $filter, $window, $http, $translate, notification,
        ...
        var exportPentaho = function (reportCategory, interval, format, dateFilter, permanentParams, additionalParams) {
            ...
            if (interval.url.indexOf('Traffic_by_App_and_ShortCode_Report') > -1) {
                $scope.exportEdrReport(reportCategory.constantParams.reportId, dateFilter.startDate, additionalParams);
            } else {
                $timeout(function () {
        ...
        $scope.export = function (reportCategory, interval, format, dateHolder, permanentParams, additionalParams) {
            try {
                ...
                // validateDateRangesAccordingToReportType(interval.name, dateHolder);
