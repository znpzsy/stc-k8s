(function () {
    ...
    angular.module('adminportal.services.cc.troubleshootingremote', []);

    var CCTroubleshootingRemoteModule = angular.module('adminportal.services.cc.troubleshootingremote');

    CCTroubleshootingRemoteModule.config(function ($stateProvider) {

        $stateProvider.state('services.cc.troubleshootingremote', {
            url: "/troubleshooting-remote",
            templateUrl: "services/cc/troubleshooting/troubleshooting.html",
            controller: 'CCTroubleshootingRemoteCtrl',
            resolve: {}
        });

    });

    CCTroubleshootingRemoteModule.controller('CCTroubleshootingRemoteCtrl', function ($scope, $log, $controller, $timeout, $filter, DateTimeConstants) {
        ...
        $controller('CCTroubleshootingRemoteTableCtrl', {$scope: $scope});
    });

    CCTroubleshootingRemoteModule.controller('CCTroubleshootingRemoteTableCtrl', function ($scope, $log, $q, UtilService, NgTableParams, notification, $translate,
                                                                                           GeneralESService, DateTimeConstants) {
        $scope.exportFileName = 'CollectCallServiceTroubleshootingRecordsRemote';
