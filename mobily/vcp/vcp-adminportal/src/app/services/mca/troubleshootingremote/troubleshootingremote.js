(function () {
    ...
    angular.module('adminportal.services.mca.troubleshootingremote', []);

    var MCATroubleshootingRemoteModule = angular.module('adminportal.services.mca.troubleshootingremote');

    MCATroubleshootingRemoteModule.config(function ($stateProvider) {

        $stateProvider.state('services.mca.troubleshootingremote', {
            url: "/troubleshooting-remote",
            templateUrl: "services/mca/troubleshooting/troubleshooting.html",
            controller: 'MCATroubleshootingRemoteCtrl',
            resolve: {}
        });

    });

    MCATroubleshootingRemoteModule.controller('MCATroubleshootingRemoteCtrl', function ($scope, $log, $controller, $timeout, $filter,
                                                                            DateTimeConstants) {
        ...
        $controller('MCATroubleshootingRemoteTableCtrl', {$scope: $scope});
    });

    MCATroubleshootingRemoteModule.controller('MCATroubleshootingRemoteTableCtrl', function ($scope, $log, $q, UtilService, NgTableParams, notification, $translate,
                                                                                 GeneralESService, DateTimeConstants) {
        $scope.exportFileName = 'MissedCallNotificationServiceTroubleshootingRecordsRemote';
