(function () {
    ...
    angular.module('adminportal.services.pokecall.troubleshootingremote', []);

    var PokeCallTroubleshootingRemoteModule = angular.module('adminportal.services.pokecall.troubleshootingremote');

    PokeCallTroubleshootingRemoteModule.config(function ($stateProvider) {

        $stateProvider.state('services.pokecall.troubleshootingremote', {
    ...
    PokeCallTroubleshootingRemoteModule.controller('PokeCallTroubleshootingRemoteTableCtrl', function ($scope, $log, $q, $filter, UtilService, NgTableParams, notification, $translate,
        ...
        $scope.exportFileName = 'PokeCallServiceTroubleshootingRecordsRemote';
