(function () {
    ...
    angular.module('adminportal.services.vm.troubleshooting', []);

    var VMTroubleshootingModule = angular.module('adminportal.services.vm.troubleshooting');

    VMTroubleshootingModule.config(function ($stateProvider) {

        $stateProvider.state('services.vm.troubleshooting', {
            url: "/troubleshooting",
            templateUrl: "services/vm/troubleshooting/troubleshooting.html",
            controller: 'VMTroubleshootingCtrl'
        });

    });

    VMTroubleshootingModule.controller('VMTroubleshootingCtrl', function ($scope, $log, $controller, $timeout, $filter, DateTimeConstants) {
        $log.debug('VMTroubleshootingCtrl');
        ...
        $controller('VMTroubleshootingTableCtrl', {$scope: $scope});
        $controller('VMTroubleshootingHistoryCtrl', {$scope: $scope});
    });

    VMTroubleshootingModule.controller('VMTroubleshootingTableCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams,
                                                                               UtilService, GeneralESService, DateTimeConstants) {
        $log.debug('VMTroubleshootingTableCtrl');

        $scope.exportFileName = 'VoiceMailServiceTroubleshootingRecords';
    ...
    VMTroubleshootingModule.controller('VMTroubleshootingHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams,
                                                                                 GeneralESService, DateTimeConstants) {
        $log.debug('VMTroubleshootingHistoryCtrl');
