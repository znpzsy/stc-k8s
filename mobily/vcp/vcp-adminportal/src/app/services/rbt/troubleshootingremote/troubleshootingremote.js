(function () {
    ...
    angular.module('adminportal.services.rbt.troubleshootingremote', []);

    var RBTTroubleshootingRemoteModule = angular.module('adminportal.services.rbt.troubleshootingremote');
    ...
    RBTTroubleshootingRemoteModule.controller('RBTTroubleshootingRemoteCtrl', function ($scope, $log, $controller, $timeout, $filter, DateTimeConstants) {
    ...
    RBTTroubleshootingRemoteModule.controller('RBTTroubleshootingRemoteTableCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams,
        ...
        $scope.exportFileName = 'RingBackToneServiceTroubleshootingRecordsRemote';
