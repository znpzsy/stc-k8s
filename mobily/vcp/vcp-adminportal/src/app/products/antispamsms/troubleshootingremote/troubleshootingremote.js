(function () {
    ...
    angular.module('adminportal.products.antispamsms.troubleshootingremote', []);

    var AntiSpamSMSTroubleshootingRemoteModule = angular.module('adminportal.products.antispamsms.troubleshootingremote');
