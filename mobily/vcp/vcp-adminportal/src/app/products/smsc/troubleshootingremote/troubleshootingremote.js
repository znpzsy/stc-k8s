(function () {
    ...
    angular.module('adminportal.products.smsc.troubleshootingremote', [
        'ngTableExport'
    ]);

    var SmscTroubleshootingRemoteModule = angular.module('adminportal.products.smsc.troubleshootingremote');

    SmscTroubleshootingRemoteModule.config(function ($stateProvider) {

        $stateProvider.state('products.smsc.troubleshootingremote', {
            abstract: true,
            url: "/troubleshooting-remote",
            templateUrl: "products/smsc/troubleshooting/troubleshooting.html"
        }).state('products.smsc.troubleshootingremote.edr', {
            abstract: true,
            url: "",
            templateUrl: 'products/smsc/troubleshooting/troubleshooting.edr.html',
            controller: 'SmscTroubleshootingRemoteCtrl',
            resolve: {
        ...
        }).state('products.smsc.troubleshootingremote.edr.view', {
            url: "",
            views: {
                'permanentTable': {
                    templateUrl: 'products/smsc/troubleshooting/troubleshooting.edr.permanent.html'
                },
                'transientTable': {
                    templateUrl: 'products/smsc/troubleshooting/troubleshooting.edr.transient.html'
                }
            }
        });
    ...
    SmscTroubleshootingRemoteModule.controller('SmscTroubleshootingRemoteCtrl', function ($scope, $log, $uibModal, $q, $filter, $timeout, $controller, $translate, notification, GeneralESService, SfeReportingService,
                                                                                          DateTimeConstants, SMSC_AGENT_TYPE, Restangular, smppApplications, organizations,
                                                                                          TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION) {
        $log.debug('SmscTroubleshootingRemoteCtrl');
        ...
        $scope.throttledReloadTable = _.throttle(function () {
            ...
            $scope.reloadTable($scope.smscPermanentEdrList.tableParams, true);
            ...
            if ($scope.dateFilter.result !== '0') {
                $scope.reloadTable($scope.smscTransientEdrList.tableParams, true);
            }
        ...
        $scope.showDetails = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/smsc/troubleshooting/troubleshooting.edr.details.html',
        ...
        $scope.showMessageContent = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/smsc/troubleshooting/troubleshooting.edr.messagecontent.html',
        ...
        $scope.backFromFilterMessageParts = function () {
            ...
            $scope.reloadTable($scope.smscPermanentEdrList.tableParams, true, $scope.permanentLatestPageNumbers[1]);
            $scope.reloadTable($scope.smscTransientEdrList.tableParams, true, $scope.transientLatestPageNumbers[1]);
        };

        $controller('SmscTroubleshootingRemotePermanentCtrl', {$scope: $scope});
        $controller('SmscTroubleshootingRemoteTransientCtrl', {$scope: $scope});

        $controller('SmscTroubleshootingRemoteHistoryCtrl', {$scope: $scope});
        $controller('SmscTroubleshootingRemoteSummarizeCtrl', {$scope: $scope});
    });

    SmscTroubleshootingRemoteModule.controller('SmscTroubleshootingRemotePermanentCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams, $controller, UtilService, DateTimeConstants,
                                                                                                   GeneralESService, SmscOperationService, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION,
                                                                                                   ReportingExportService) {
        $log.debug('SmscTroubleshootingRemotePermanentCtrl');
    ...
    SmscTroubleshootingRemoteModule.controller('SmscTroubleshootingRemoteTransientCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, $sce, NgTableParams, $controller, UtilService, DateTimeConstants,
                                                                                                   SfeReportingService, SmscOperationService, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION, ReportingExportService) {
        $log.debug('SmscTroubleshootingRemoteTransientCtrl');
    ...
    SmscTroubleshootingRemoteModule.controller('SmscTroubleshootingRemoteHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams, DateTimeConstants) {
        $log.debug('SmscTroubleshootingRemoteHistoryCtrl');
        ...
        $scope.showSmscHistory = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/smsc/troubleshooting/troubleshooting.edr.history.html',
                controller: function ($scope, $uibModalInstance, smscHistoryEdrs, edrRecord, smscEdrHistoryList, recordType) {
                    edrRecord.rowSelected = true;
    ...
    SmscTroubleshootingRemoteModule.controller('SmscTroubleshootingRemoteSummarizeCtrl', function ($scope, $log) {
        $log.debug('SmscTroubleshootingRemoteSummarizeCtrl');
