(function () {
    ...
    /* Constants */
    angular.module('adminportal.products.mmsc.constants', []);

    var MmscConstants = angular.module('adminportal.products.mmsc.constants');

    MmscConstants.constant('MMSC_MAIN_CONTENT_TYPE_LIST', [
        {id: 1, name: 'audio'},
        {id: 2, name: 'video'},
        {id: 3, name: 'text'},
    ...
    MmscConstants.constant('MMSC_DELIVERY_REPORT_POLICY', [
        {type_key: 0, text: 'NEVER'},
        {type_key: 1, text: 'CONDITIONAL'},
        {type_key: 2, text: 'ALWAYS'}
    ]);
