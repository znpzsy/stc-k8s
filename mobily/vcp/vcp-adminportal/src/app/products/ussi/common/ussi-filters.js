(function () {
    ...
    /* Filters */
    angular.module('adminportal.products.ussi.filters', []);

    var UssiFilters = angular.module('adminportal.products.ussi.filters');
    ...
    // Todo: See SMSC Filters for reference, this is not yet done.
