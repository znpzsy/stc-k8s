(function () {
    ...
    angular.module('adminportal.products.usc.troubleshooting', []);

    var USCTroubleshootingModule = angular.module('adminportal.products.usc.troubleshooting');

    USCTroubleshootingModule.config(function ($stateProvider) {

        $stateProvider.state('products.usc.troubleshooting', {
            url: "/troubleshooting",
            templateUrl: "products/usc/troubleshooting/troubleshooting.html",
            controller: 'USCTroubleshootingCtrl'
        });

    });

    USCTroubleshootingModule.controller('USCTroubleshootingCtrl', function ($scope, $log, $controller, $timeout, $filter, DateTimeConstants, USC_POINT_TYPES) {
        ...
        $controller('USCTroubleshootingTableCtrl', {$scope: $scope});
    });

    USCTroubleshootingModule.controller('USCTroubleshootingTableCtrl', function ($scope, $log, $q, $filter, UtilService, NgTableParams, notification, $translate,
