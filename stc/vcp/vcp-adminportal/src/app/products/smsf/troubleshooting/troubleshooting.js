(function () {
    ...
    angular.module('adminportal.products.smsf.troubleshooting', []);

    var SMSFTroubleshootingModule = angular.module('adminportal.products.smsf.troubleshooting');

    SMSFTroubleshootingModule.config(function ($stateProvider) {

        $stateProvider.state('products.smsf.troubleshooting', {
            url: "/troubleshooting",
            templateUrl: "products/smsf/troubleshooting/troubleshooting.html",
            controller: 'SMSFTroubleshootingCtrl'
        });

    });

    SMSFTroubleshootingModule.controller('SMSFTroubleshootingCtrl', function ($scope, $log, $controller, $timeout, $filter, DateTimeConstants) {
        ...
        $controller('SMSFTroubleshootingTableCtrl', {$scope: $scope});
    });

    SMSFTroubleshootingModule.controller('SMSFTroubleshootingTableCtrl', function ($scope, $log, $q, $filter, UtilService, NgTableParams, notification, $translate,
        ...
        $scope.showHistory = function (edrRecord) {
            ...
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/smsf/troubleshooting/troubleshooting.edr.history.html',
                size: 'xlg',
                resolve: {
        ...
        $scope.showDetails = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/smsf/troubleshooting/troubleshooting.edr.detail.html',
