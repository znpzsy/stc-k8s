(function () {
    ...
    angular.module('adminportal.products.smsc.troubleshooting', [
        'ngTableExport'
    ]);

    var SmscTroubleshootingModule = angular.module('adminportal.products.smsc.troubleshooting');

    SmscTroubleshootingModule.config(function ($stateProvider) {

        $stateProvider.state('products.smsc.troubleshooting', {
            abstract: true,
            url: "/troubleshooting",
            templateUrl: "products/smsc/troubleshooting/troubleshooting.html"
        }).state('products.smsc.troubleshooting.edr', {
            abstract: true,
            url: "",
            templateUrl: 'products/smsc/troubleshooting/troubleshooting.edr.html',
            controller: 'SmscTroubleshootingCtrl',
            resolve: {
        ...
        }).state('products.smsc.troubleshooting.edr.view', {
            url: "",
            views: {
                'permanentTable': {
    ...
    SmscTroubleshootingModule.controller('SmscTroubleshootingCtrl', function ($scope, $log, $uibModal, $q, $filter, $timeout, $controller, $translate, notification, GeneralESService, SfeReportingService,
        ...
        $log.debug('SmscTroubleshootingCtrl');
        ...
        $controller('SmscTroubleshootingPermanentCtrl', {$scope: $scope});
        $controller('SmscTroubleshootingTransientCtrl', {$scope: $scope});

        $controller('SmscTroubleshootingHistoryCtrl', {$scope: $scope});
        $controller('SmscTroubleshootingSummarizeCtrl', {$scope: $scope});
    });

    SmscTroubleshootingModule.controller('SmscTroubleshootingPermanentCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams, $controller, UtilService, DateTimeConstants,
                                                                                       GeneralESService, SmscOperationService, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION,
                                                                                       ReportingExportService) {
        $log.debug('SmscTroubleshootingPermanentCtrl');
    ...
    SmscTroubleshootingModule.controller('SmscTroubleshootingTransientCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, $sce, NgTableParams, $controller, UtilService, DateTimeConstants,
                                                                                       SfeReportingService, SmscOperationService, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION, ReportingExportService) {
        $log.debug('SmscTroubleshootingTransientCtrl');
    ...
    SmscTroubleshootingModule.controller('SmscTroubleshootingHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams, DateTimeConstants) {
        $log.debug('SmscTroubleshootingHistoryCtrl');
    ...
    SmscTroubleshootingModule.controller('SmscTroubleshootingSummarizeCtrl', function ($scope, $log) {
        $log.debug('SmscTroubleshootingSummarizeCtrl');
