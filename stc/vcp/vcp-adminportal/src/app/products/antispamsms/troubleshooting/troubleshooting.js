(function () {
    ...
    AntiSpamSMSTroubleshootingModule.controller('AntiSpamSMSTroubleshootingCommonCtrl', function ($scope, $sce, $log, $q, $filter, $controller, $timeout, notification, $translate, $uibModal, NgTableParams, ReportingExportService,
        ...
        $log.debug('AntiSpamSMSTroubleshootingCommonCtrl');
    ...
    AntiSpamSMSTroubleshootingModule.controller('AntiSpamSMSTroubleshootingCtrl', function ($scope, $sce, $log, $q, $filter, $controller, notification, NgTableParams, TROUBLESHOOTING_RECORD_COUNT_LIMIT_FOR_NOTIFICATION, ReportingExportService,GeneralESService, idFilterTimespans) {
            ...
            var modalInstance = $uibModal.open({
                ...
                resolve: {
                    smsAntiSpamEdrs: function ($filter, GeneralESService, DateTimeConstants, $log) {
                        ...
                        bodyPayload.query.bool.must.push(idFilter);
