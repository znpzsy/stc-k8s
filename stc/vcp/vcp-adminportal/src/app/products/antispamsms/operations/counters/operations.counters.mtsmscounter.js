(function () {
    ...
    AntiSpamSMSOperationsCountersMTSMSCounterModule.controller('AntiSpamSMSOperationsCountersMTSMSCounterCommonCtrl', function ($scope, $log, $state, SMS_ANTISPAM_COUNTER_TYPES, STATES, SMS_ANTISPAM_RANGE_POLICIES, SMS_ANTISPAM_REJECT_METHODS_3, SMS_ANTISPAM_SIMILARITY_ALGORITHMS) {
    ...
    AntiSpamSMSOperationsCountersMTSMSCounterModule.controller('AntiSpamSMSOperationsCountersNewMTSMSCounterCtrl', function ($scope, $log, $controller, $state, $translate, notification, SMSAntiSpamConfigService) {
        ...
        $scope.entry = {
            ...
            similarityAlgorithm: $scope.SMS_ANTISPAM_SIMILARITY_ALGORITHMS[0].value,
            reputationLoss: 0
        };
