(function () {
    ...
    var moSMSCounterListStateDef = function (participant, type) {
        return {
            url: "/list",
            templateUrl: "products/antispamsms/operations/counters/operations.counters.html",
    ...
    var moSMSCounterNewStateDef = function (participant, type) {
        return {
            url: "/new",
            templateUrl: "products/antispamsms/operations/counters/operations.counters.detail.html",
    ...
    AntiSpamSMSOperationsCountersMOSMSCounterModule.controller('AntiSpamSMSOperationsCountersMOSMSCounterCommonCtrl', function ($scope, $log, $state, SMS_ANTISPAM_COUNTER_TYPES, STATES, SMS_ANTISPAM_RANGE_POLICIES, SMS_ANTISPAM_REJECT_METHODS_3, SMS_ANTISPAM_SIMILARITY_ALGORITHMS) {
    ...
    AntiSpamSMSOperationsCountersMOSMSCounterModule.controller('AntiSpamSMSOperationsCountersMOSMSCounterCtrl', function ($scope, $log, $controller, $uibModal, $filter, $translate, notification, NgTableParams, NgTableService,
        ...
        $scope.setAddressRange = function (entry) {
            $uibModal.open({
                templateUrl: 'products/antispamsms/operations/counters/operations.counters.addressranges.modal.html',
    ...
    AntiSpamSMSOperationsCountersMOSMSCounterModule.controller('AntiSpamSMSOperationsCountersNewMOSMSCounterCtrl', function ($scope, $log, $controller, $state, $translate, notification, SMSAntiSpamConfigService) {
        ...
        if($state.current.data.type === 'CONTENT_SENSITIVE_SINGLE_RECIPIENT' || $state.current.data.type === 'CONTENT_SENSITIVE_MULTIPLE_RECIPIENT') {
            $scope.entry.similarityAlgorithm = $scope.SMS_ANTISPAM_SIMILARITY_ALGORITHMS[0].value;
            $scope.entry.nilsimsaSimilarityRatio = 80;
        }
