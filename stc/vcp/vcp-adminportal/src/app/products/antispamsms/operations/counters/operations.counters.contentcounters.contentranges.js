(function () {
    ...
    angular.module('adminportal.products.antispamsms.operations.counters.contentcounters.contentranges', []);

    var AntiSpamSMSOperationsCountersContentRangesModule = angular.module('adminportal.products.antispamsms.operations.counters.contentcounters.contentranges');

    AntiSpamSMSOperationsCountersContentRangesModule.controller('AntiSpamSMSOperationsCountersContentRangesCtrl', function ($scope, $uibModalInstance, $log, $filter, $uibModal, $translate, notification, NgTableParams, NgTableService,
                                                                                                                                        SMSAntiSpamConfigService, SMS_ANTISPAM_APPLICABLE_RANGES, msisdnRanges, addressRanges, contentFiltersEntry) {
        $log.debug("AntiSpamSMSOperationsCountersContentRangesCtrl");
