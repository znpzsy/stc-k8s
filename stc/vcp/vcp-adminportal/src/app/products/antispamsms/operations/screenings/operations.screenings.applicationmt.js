(function () {
    ...
    AntiSpamSMSOperationsScreeningsApplicationMTModule.config(function ($stateProvider) {
        ...
        $stateProvider.state('products.antispamsms.operations.screenings.applicationmt', {
            ...
            url: "/list",
            templateUrl: "products/antispamsms/operations/screenings/operations.screenings.applicationmt.html",
    ...
    AntiSpamSMSOperationsScreeningsApplicationMTModule.controller('AntiSpamSMSOperationsScreeningsApplicationMTCtrl', function ($scope, $log, $uibModal, $filter, $translate, notification, NgTableParams, NgTableService,
        ...
        var openDetailModal = function (entry) {
            return $uibModal.open({
                templateUrl: 'products/antispamsms/operations/screenings/operations.screenings.applicationmt.detail.modal.html',
        ...
        var updateList = function (dataType) {
            if (dataType === 'ALL') {
                $scope.whiteList.list = $scope.exclusionList;
            } else {
                $scope.whiteList.list = _.where($scope.exclusionList, {"type": dataType});
            }
        ...
        $scope.setSMSCSGT = function (entry) {
            $uibModal.open({
                templateUrl: 'products/antispamsms/operations/screenings/operations.screenings.applicationmt.smscgt.modal.html',
