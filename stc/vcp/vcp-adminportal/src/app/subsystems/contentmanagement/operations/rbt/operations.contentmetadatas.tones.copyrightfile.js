(function () {
    ...
    angular.module('adminportal.subsystems.contentmanagement.operations.rbt.contentmetadatas.tones.copyrightfile', []);

    var ContentManagementOperationsContentMetadatasRBTTonesCopyrightFileModule = angular.module('adminportal.subsystems.contentmanagement.operations.rbt.contentmetadatas.tones.copyrightfile');

    ContentManagementOperationsContentMetadatasRBTTonesCopyrightFileModule.controller('ContentManagementOperationsContentMetadatasRBTTonesCopyrightFileCtrl', function ($scope, $log, $uibModal, $filter, DateTimeConstants) {
        $log.debug('ContentManagementOperationsContentMetadatasRBTTonesCopyrightFileCtrl');

        // CopyrightFiles managing methods.
        $scope.addCopyrightFile = function (contentMetadata) {
            var modalInstance = $uibModal.open({
                templateUrl: 'subsystems/contentmanagement/operations/rbt/operations.contentmetadatas.tones.copyrightfile.modal.html',
        ...
        $scope.getCopyrightFileString = function (copyrightFile) {
            var fileName = copyrightFile.copyrightFile && copyrightFile.copyrightFile.name ? copyrightFile.copyrightFile.name + ', ' : '';
            var resultStr = fileName +
