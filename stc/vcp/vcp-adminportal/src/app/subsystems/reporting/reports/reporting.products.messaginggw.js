(function () {
    ...
    ReportingReportsMessagingGwModule.controller('ReportingReportsMessagingGwCtrl', function ($scope, $log, $controller, $filter, Restangular, CMPFService, UtilService, REPORTING_MSGGW_REPORT_CHANNELS,
        ...
        var MSGGW_SMS_Traffic_Summary_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Traffic_Summary_Report.prpt');
        var MSGGW_SMS_Traffic_Details_by_Organization_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Traffic_Details_by_Organization_Report.prpt');
        var MSGGW_SMS_Traffic_Details_by_Service_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Traffic_Details_by_Service_Report.prpt');
        var MSGGW_SMS_Traffic_Details_by_Period_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Traffic_Details_by_Period_Report.prpt');
        var MSGGW_SMS_Traffic_Busy_Period_Report = UtilService.defineReportsAsDH(':home:vcp:MessagingGW:MSGGW_SMS_Traffic_Busy_Period_Report.prpt');
        var MSGGW_SMS_Performance_Summary_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Performance_Summary_Report.prpt');
        var MSGGW_SMS_Performance_by_Organization_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Performance_by_Organization_Report.prpt');
        var MSGGW_SMS_Performance_by_Service_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Performance_by_Service_Report.prpt');
        var MSGGW_SMS_Performance_by_Period_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Performance_by_Period_Report.prpt');
        var MSGGW_SMS_Error_Details_Summary_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Error_Details_Summary_Report.prpt');
        var MSGGW_SMS_Error_Details_by_Organization_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Error_Details_by_Organization_Report.prpt');
        var MSGGW_SMS_Error_Details_by_Service_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Error_Details_by_Service_Report.prpt');
        var MSGGW_SMS_Error_Details_by_Period_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_SMS_Error_Details_by_Period_Report.prpt');
        //var MSGGW_Free_Vs_Charged_SMS_By_Organization_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_Free_Vs_Charged_SMS_By_Organization_Report.prpt');
        //var MSGGW_Free_Vs_Charged_SMS_By_Service_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_Free_Vs_Charged_SMS_By_Service_Report.prpt');
        //var MSGGW_Free_Vs_Charged_SMS_By_Period_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_Free_Vs_Charged_SMS_By_Period_Report.prpt');
        var MSGGW_SMS_General_Delivery_Errors_Report = UtilService.defineReportsAsD(':home:vcp:MessagingGW:MSGGW_SMS_General_Delivery_Errors_Report.prpt');
/*
        var MSGGW_MMS_Traffic_Summary_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Traffic_Summary_Report.prpt');
        var MSGGW_MMS_Traffic_Details_by_Organization_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Traffic_Details_by_Organization_Report.prpt');
        var MSGGW_MMS_Traffic_Details_by_Service_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Traffic_Details_by_Service_Report.prpt');
        var MSGGW_MMS_Traffic_Details_by_Period_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Traffic_Details_by_Period_Report.prpt');
        var MSGGW_MMS_Traffic_Busy_Period_Report = UtilService.defineReportsAsDH(':home:vcp:MessagingGW:MSGGW_MMS_Traffic_Busy_Period_Report.prpt');
        var MSGGW_MMS_Performance_Summary_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Performance_Summary_Report.prpt');
        var MSGGW_MMS_Performance_by_Organization_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Performance_by_Organization_Report.prpt');
        var MSGGW_MMS_Performance_by_Service_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Performance_by_Service_Report.prpt');
        var MSGGW_MMS_Performance_by_Period_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Performance_by_Period_Report.prpt');
        var MSGGW_MMS_Error_Details_Summary_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Error_Details_Summary_Report.prpt');
        var MSGGW_MMS_Error_Details_by_Organization_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Error_Details_by_Organization_Report.prpt');
        var MSGGW_MMS_Error_Details_by_Service_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Error_Details_by_Service_Report.prpt');
        var MSGGW_MMS_Error_Details_by_Period_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_MMS_Error_Details_by_Period_Report.prpt');
        var MSGGW_Free_Vs_Charged_MMS_By_Organization_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_Free_Vs_Charged_MMS_By_Organization_Report.prpt');
        var MSGGW_Free_Vs_Charged_MMS_By_Service_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_Free_Vs_Charged_MMS_By_Service_Report.prpt');
        var MSGGW_Free_Vs_Charged_MMS_By_Period_Report = UtilService.defineReportsAsDHM(':home:vcp:MessagingGW:MSGGW_Free_Vs_Charged_MMS_By_Period_Report.prpt');
*/
        var SMS_REPORTS = [
