(function () {
    ...
    ReportingReportsRBTModule.controller('ReportingReportsRBTCtrl', function ($scope, $log, $controller, $filter, Restangular, UtilService, organizations) {
        ...
        var RBT_Content_Assignment_Report = UtilService.defineReportsAsD(':home:vcp:RBT:RBT_Content_Assignment_Report.prpt');
        var RBT_Content_Subscription_Report = [{name: 'ALL', url: ':home:vcp:RBT:RBT_Content_Subscription_Report.prpt'}];
        var RBT_Content_Usage_Report = UtilService.defineReportsAsDM(':home:vcp:RBT:RBT_Content_Usage_Report.prpt');

        // Campaign Reports
        var RBT_Campaign_Happy_Hour_Report =  UtilService.defineReportsAsDHM(':home:vcp:RBT:RBT_Campaign_Happy_Hour_Report.prpt');
        var RBT_Campaign_Bogof_Report =  UtilService.defineReportsAsDHM(':home:vcp:RBT:RBT_Campaign_Bogof_Report.prpt');
        $scope.csvFormat = [
        ...
        $scope.REPORTS = [
            ...
            // Content
            {
                ...
                label: 'Ring Back Tone Content Assignment Report',
                intervals: RBT_Content_Assignment_Report,
                additionalFields: ['topNSelectMandatory']
            },
            {
                group: 'Content Reports',
                label: 'Ring Back Tone Content Daily Subscription Report',
                intervals: RBT_Content_Subscription_Report,
                additionalFields: ['organizationId', 'topNSelectMandatory']
            },
            {
                group: 'Content Reports',
                label: 'Ring Back Tone Content Usage Report',
                intervals: RBT_Content_Usage_Report
            },
            // Campaign Reports
            {
                group: 'Campaign Reports',
                label: 'Ring Back Tone Happy Hour Campaigns Report',
                intervals: RBT_Campaign_Happy_Hour_Report
            },
            {
                group: 'Campaign Reports',
                label: 'Ring Back Tone Buy One Get One Free Campaigns Report',
                intervals: RBT_Campaign_Bogof_Report
            }
        ];
