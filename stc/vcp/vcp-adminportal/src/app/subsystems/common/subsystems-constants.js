(function () {
    ...
    // TODO: Remove this constant after the implementation of the OB_IVR screens, under proper navigation
    SubsystemsConstants.constant('REPORTING_OBIVR_CALL_FLOWS', [
        {value: 'broadcast', text: 'Broadcast'},
        {value: 'offer', text: 'Offer'},
        {value: 'sada', text: 'Sada'},
        {value: 'sadaPP', text: 'SadaPP'},
    ...
    SubsystemsConstants.constant('PROVISIONING_PAYMENT_TYPES_NGSSM', [
    ...
    SubsystemsConstants.constant('PROVISIONING_GENDERS', [
        {label: 'ProvisioningGenders.Male', value: "MALE"},
        {label: 'ProvisioningGenders.Female', value: "FEMALE"}
    ]);
    ...
    SubsystemsConstants.constant('CMS_CODECS', ['ALAW', 'ULAW', 'PCM_SIGNED']);
    ...
    SubsystemsConstants.constant('CMS_ACCESS_CHANNELS', [
        {label: 'IVR', value: ['IVR'], numericValue: 0},
        {label: 'USSD', value: ['USSD'], numericValue: 1},
        {label: 'GENERAL', value: ['SMS', 'SMS_HU', 'IVR_FK', 'CC', 'AdminPortal', 'RBTPortal', 'RBTMobileApp', 'MySTC', 'CPWhiteBrandedPortal', 'CorporatePortal', 'BackOfficeBulkOps', 'RBTBackend', 'RBTDecisionEngine'], numericValue: 2}
    ]);
    ...
    SubsystemsConstants.constant('CMS_SIGNATURE_TYPES', [
        {key: 'mySignature', label: 'SignatureTypes.predefined'},
        {key: 'prayer', label: 'SignatureTypes.prayer'},
        {key: 'reverseSignature', label: 'SignatureTypes.reverseSignature'}
    ]);

    // Added for reference
    SubsystemsConstants.constant('CMS_RBT_RESOURCE_TYPES', [
        'TONE',
        'ARTIST',
        'ALBUM',
        'PLAYLIST',
    ...
    SubsystemsConstants.constant('CMS_RBT_DIY_STATUS_TYPES', ['PENDING', 'ACTIVE', 'REJECTED']);

    SubsystemsConstants.constant('CMS_RBT_CONTENT_TYPES', ['CATEGORY', 'ARTIST', 'PLAYLIST', 'TONE']);

    SubsystemsConstants.constant('CMS_RBT_REV_SHARE_POLICIES_ALL', ['NONE', 'COMPLEX']);
    SubsystemsConstants.constant('CMS_RBT_REV_SHARE_POLICIES_TONE', ['SIMPLE', 'NONE']);
    ...
    // White-label Portal constants
    SubsystemsConstants.constant('CMS_RBT_WBP_FALLBACK_FONTS', [
        'STC Forward, sans-serif',
        'Arial, sans-serif',
        'Verdana, sans-serif',
        'Tahoma, sans-serif',
    ...
    SubsystemsConstants.constant('CMS_RBT_WBP_CUSTOM_FONT_TYPES', [
        'sans-serif',
        'serif',
        'script',
        'monospace',
    ...
    SubsystemsConstants.constant('SUBSCRIPTION_MANAGEMENT_CHANNEL_TYPES', [
        ...
        {value: 'DGTL_WEB', text: 'Subscriber Portal [DGTL_WEB]'},
        {value: 'DGTL_APP', text: 'Mobile Application [DGTL_APP]'},
        // TODO: Remove the following after checking with Subscription Mgmt
        // {value: 'IVR_MBLY', text: 'Mobily IVR [IVR_MBLY]'},
        // {value: 'USSD_MBLY', text: 'Mobily USSD [USSD_MBLY]'},
        // {value: 'DGTL_WEB_MBLY', text: 'Mobily E-Portal [DGTL_WEB_MBLY]'},
        {value: 'IVR_STC', text: 'STC IVR [IVR_STC]'},
