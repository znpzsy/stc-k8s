(function () {
    ...
    angular.module('adminportal.subsystems.subscriptionmanagement.troubleshooting.servicesubscription', []);

    var SubscriptionManagementTroubleshootingServiceSubscriptionModule = angular.module('adminportal.subsystems.subscriptionmanagement.troubleshooting.servicesubscription');
