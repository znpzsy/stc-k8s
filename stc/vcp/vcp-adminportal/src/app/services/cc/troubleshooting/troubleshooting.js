(function () {
    ...
    CCTroubleshootingModule.controller('CCTroubleshootingCtrl', function ($scope, $log, $controller, $timeout, $filter, DateTimeConstants) {
        ...
        $controller('CCTroubleshootingHistoryCtrl', {$scope: $scope});
    });
    ...
    CCTroubleshootingModule.controller('CCTroubleshootingHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams,
                                                                                 GeneralESService, DateTimeConstants) {
        $log.debug('CCTroubleshootingHistoryCtrl');
        ...
        $scope.showCCHistory = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'services/cc/troubleshooting/troubleshooting.edr.history.html',
