(function () {
    ...
    angular.module('adminportal.services.cmb.troubleshooting', []);

    var CMBTroubleshootingModule = angular.module('adminportal.services.cmb.troubleshooting');
    ...
    CMBTroubleshootingModule.controller('CMBTroubleshootingTableCtrl', function ($scope, $log, $q, UtilService, NgTableParams, notification, $translate,
                                                                                 GeneralESService, DateTimeConstants) {
        $scope.exportOptions = {
            columns: [
                {
                    fieldName: 'timestamp',
                    headerKey: 'Services.P4M.Troubleshooting.TableColumns.Time',
                    filter: {name: 'date', params: ['yyyy-MM-dd HH:mm:ss', DateTimeConstants.OFFSET]}
                },
                {
                    fieldName: 'aPartyMsisdn',
                    headerKey: 'Services.P4M.Troubleshooting.TableColumns.APartyMsisdn'
                },
                {
                    fieldName: 'aPartyPaymentType',
                    headerKey: 'Services.P4M.Troubleshooting.TableColumns.APartyPaymentType'
                },
                {
                    fieldName: 'bPartyMsisdn',
                    headerKey: 'Services.P4M.Troubleshooting.TableColumns.BPartyMsisdn'
                },
                {
                    fieldName: 'bPartyPaymentType',
                    headerKey: 'Services.P4M.Troubleshooting.TableColumns.BPartyPaymentType'
                },
                {
                    fieldName: 'sessionId',
                    headerKey: 'Services.P4M.Troubleshooting.TableColumns.SessionId'
                },
                {
                    fieldName: 'eventInfo',
                    headerKey: 'Services.P4M.Troubleshooting.TableColumns.EventInfo'
                }
            ]
        };
