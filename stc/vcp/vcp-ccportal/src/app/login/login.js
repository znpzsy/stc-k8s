(function () {
    ...
    LoginModule.controller('LoginCtrl', function ($rootScope, $q, $scope, $log, $http, $interval, $window, CMPFService, ServerConfigurationService, notification, $translate, $state, $stateParams, IdleServiceFactory,
        ...
        $scope.login = function (user) {
            if ($scope.loginForm.$valid) {
                ...
                deferredUserAuthenticate.promise.then(function (authenticateResponse) {
                    ...
                    // If user authenticated and is authorized for ccportal, check user info & store necessary info in local storage.
