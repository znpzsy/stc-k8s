(function () {
    ...
    angular.module('ccportal.products.messaginggw.troubleshooting', []);

    var ActivityHistoryMessagingHistoryModule = angular.module('ccportal.products.messaginggw.troubleshooting');
