(function () {
    ...
    angular.module('ccportal.products.charginggw.troubleshooting', []);

    var ActivityHistoryChargingHistoryModule = angular.module('ccportal.products.charginggw.troubleshooting');
    ...
    ActivityHistoryChargingHistoryModule.config(function ($stateProvider) {
        ...
        $stateProvider.state('products.charginggw.troubleshooting', {
            ...
            templateUrl: "products/charginggw/activity-history/troubleshooting.html",
    ...
    ActivityHistoryChargingHistoryModule.controller('ActivityHistoryChargingHistoryTableCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams,
        ...
        $scope.showDetails = function (edrRecord) {
            ...
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/charginggw/activity-history/troubleshooting.edr.details.html',
        ...
        $log.debug('Charging record item: ', selectedEdrRecord);
            ...
            var modalInstance = $uibModal.open({
                templateUrl: 'products/charginggw/activity-history/troubleshooting.edr.refundconfirmation.modal.html',
                size: 'lg',
