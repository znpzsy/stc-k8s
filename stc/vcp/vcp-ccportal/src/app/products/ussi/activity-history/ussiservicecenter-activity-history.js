(function () {
    ...
    angular.module('ccportal.products.ussi.activity-history', []);

    var USSIActivityHistoryModule = angular.module('ccportal.products.ussi.activity-history');

    USSIActivityHistoryModule.config(function ($stateProvider) {

        $stateProvider.state('products.ussi.activity-history', {
            url: "/activity-history",
            templateUrl: "products/ussi/activity-history/ussiservicecenter-activity-history.html",
            controller: 'USSIActivityHistoryCtrl'
        });

    });

    USSIActivityHistoryModule.controller('USSIActivityHistoryCtrl', function ($scope, $log, $controller, $timeout, $filter, DateTimeConstants, Restangular,
        ...
        $controller('USSIActivityHistoryTableCtrl', {$scope: $scope});
    });

    USSIActivityHistoryModule.controller('USSIActivityHistoryTableCtrl', function ($scope, $log, $filter, UtilService, NgTableParams, notification, $translate,
        ...
        $scope.showHistory = function (edrRecord) {
            ...
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/ussi/activity-history/ussiservicecenter-activity-history-edr-history.html',
                size: 'xlg',
                resolve: {
        ...
        $scope.showDetails = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'products/ussi/activity-history/ussiservicecenter-activity-history-edr-detail.html',
