(function () {
    ...
    angular.module('ccportal.services.vsms.activity-history', []);

    var VSMSTroubleshootingModule = angular.module('ccportal.services.vsms.activity-history');

    VSMSTroubleshootingModule.config(function ($stateProvider) {

        $stateProvider.state('services.vsms.activity-history', {
            url: "/activity-history",
            templateUrl: "services/vsms/activity-history/vsms-activity-history.html",
            controller: 'VSMSTroubleshootingCtrl'
        });

    });

    VSMSTroubleshootingModule.controller('VSMSTroubleshootingCtrl', function ($scope, $log, $controller, $timeout, $filter, UtilService, DateTimeConstants) {
    ...
    VSMSTroubleshootingModule.controller('VSMSTroubleshootingHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams,
        ...
        $scope.showVSMSHistory = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'services/vsms/activity-history/vsms-activity-history.history.html',
