(function () {
    ...
    angular.module('ccportal.services.rbt.troubleshooting', []);

    var RBTTroubleshootingModule = angular.module('ccportal.services.rbt.troubleshooting');
    ...
    RBTTroubleshootingModule.controller('RBTTroubleshootingCtrl', function ($scope, $log, $controller, $timeout, $filter, UtilService, DateTimeConstants) {
    ...
    RBTTroubleshootingModule.controller('RBTTroubleshootingTableCtrl', function ($scope, $log, $q, $filter, notification, $translate, $uibModal, NgTableParams,
        ...
        $scope.exportFileName = 'RingBackToneServiceActivityHistoryRecords';
