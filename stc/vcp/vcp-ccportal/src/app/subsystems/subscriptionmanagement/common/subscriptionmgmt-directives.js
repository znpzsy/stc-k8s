(function () {
    ...
    /* Constants */
    angular.module('ccportal.subsystems.subscriptionmanagement.directives', []);

    var SubscriptionMgmtDirectives = angular.module('ccportal.subsystems.subscriptionmanagement.directives');

    SubscriptionMgmtDirectives.directive('availablityCheck', function () {
        return {
    ...
    SubscriptionMgmtDirectives.directive('subscribersNumberCheck', function () {
        return {
            // restrict to an attribute type.
            restrict: 'A',
            // element must have ng-model attribute.
