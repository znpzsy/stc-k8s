(function () {
    ...
    angular.module('ccportal.subsystems.subscriptionmanagement.content.troubleshooting', []);

    var ActivityHistoryContentSubscriptionHistoryModule = angular.module('ccportal.subsystems.subscriptionmanagement.content.troubleshooting');

    ActivityHistoryContentSubscriptionHistoryModule.config(function ($stateProvider) {

        $stateProvider.state('subsystems.subscriptionmanagement.content.troubleshooting', {
            url: "/content-subscription",
            templateUrl: "subsystems/subscriptionmanagement/content/csm-subscriptionhistory.html",
            controller: 'ActivityHistoryContentSubscriptionHistoryCtrl'
        });

    });

    ActivityHistoryContentSubscriptionHistoryModule.controller('ActivityHistoryContentSubscriptionHistoryCtrl', function ($scope, $log, $controller, $timeout, $filter, Restangular, UtilService, DateTimeConstants, ContentManagementService,
                                                                                                                          DEFAULT_REST_QUERY_LIMIT, CMS_RBT_CONTENT_TYPES, SUBSCRIPTION_MANAGEMENT_CHANNEL_TYPES_RBT) {
        $log.debug('ActivityHistoryContentSubscriptionHistoryCtrl');
        ...
        $controller('ActivityHistoryContentSubscriptionHistoryTableCtrl', {$scope: $scope});
        $controller('ActivityHistoryContentSubscriptionHistoryHistoryCtrl', {$scope: $scope});
    });

    ActivityHistoryContentSubscriptionHistoryModule.controller('ActivityHistoryContentSubscriptionHistoryTableCtrl', function ($scope, $log, $filter, $uibModal, NgTableParams, notification, $translate, UtilService,
        ...
        $scope.showDetails = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'subsystems/subscriptionmanagement/content/subscriptionhistory.edr.details.html',
    ...
    ActivityHistoryContentSubscriptionHistoryModule.controller('ActivityHistoryContentSubscriptionHistoryHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams,
                                                                                                                                 GeneralESService, DateTimeConstants) {
        $log.debug('ActivityHistoryContentSubscriptionHistoryHistoryCtrl');
        ...
        $scope.showHistory = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'subsystems/subscriptionmanagement/content/subscriptionhistory.edr.history.html',
