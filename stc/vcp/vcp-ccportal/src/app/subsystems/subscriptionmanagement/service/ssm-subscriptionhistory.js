(function () {
    ...
    angular.module('ccportal.subsystems.subscriptionmanagement.service.troubleshooting', []);

    var ActivityHistoryServiceSubscriptionHistoryModule = angular.module('ccportal.subsystems.subscriptionmanagement.service.troubleshooting');

    ActivityHistoryServiceSubscriptionHistoryModule.config(function ($stateProvider) {

        $stateProvider.state('subsystems.subscriptionmanagement.service.troubleshooting', {
            url: "/subscription-history",
            templateUrl: "subsystems/subscriptionmanagement/service/ssm-subscriptionhistory.html",
    ...
    ActivityHistoryServiceSubscriptionHistoryModule.controller('ActivityHistoryServiceSubscriptionHistoryTableCtrl', function ($scope, $log, $filter, $uibModal, NgTableParams, notification, $translate, UtilService,
        ...
        $scope.showDetails = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'subsystems/subscriptionmanagement/service/subscriptionhistory.edr.details.html',
    ...
    ActivityHistoryServiceSubscriptionHistoryModule.controller('ActivityHistoryServiceSubscriptionHistoryHistoryCtrl', function ($scope, $log, $filter, notification, $translate, $uibModal, NgTableParams,
        ...
        $scope.showHistory = function (edrRecord) {
            var modalInstance = $uibModal.open({
                animation: false,
                templateUrl: 'subsystems/subscriptionmanagement/service/subscriptionhistory.edr.history.html',
