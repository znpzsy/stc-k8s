(function () {
    ...
    PartnerInfoConstants.constant('OFFER_BUNDLING_TYPES', ['SOFT_BUNDLE', 'HARD_BUNDLE']); // 'NOT_BUNDLED' for the disabled offer bundling

    PartnerInfoConstants.constant('OFFER_ELIGIBILITY_EVALUATION_POLICIES', ['N/A', 'BLACKLIST', 'WHITELIST']);

    PartnerInfoConstants.constant('OFFER_MAIN_OFFER_EVALUATION_POLICY', ['N/A', 'ALL_OF', 'ANY_OF', 'NONE_OF']);
    ...
    PartnerInfoConstants.constant('CMS_CODECS', ['ALAW', 'ULAW', 'PCM_SIGNED']);

    //PartnerInfoConstants.constant('CMS_ACCESS_CHANNELS', ["IVR", "USSD", "SMS", "SMS_HU", "IVR_FK", "CC", "AdminPortal", "RBTPortal", "RBTMobileApp", "MySTC", "CPWhiteBrandedPortal", "CorporatePortal", "BackOfficeBulkOps", "RBTBackend", "RBTDecisionEngine"]);
    PartnerInfoConstants.constant('CMS_ACCESS_CHANNELS', [
    ...
    PartnerInfoConstants.constant('CMS_RBT_STATUS_TYPES', ['PENDING', 'ACTIVE', 'HIDDEN', 'SUSPENDED', 'REJECTED', 'INACTIVE']);

    PartnerInfoConstants.constant('CMS_RBT_CONTENT_TYPES', ['CATEGORY', 'ARTIST', 'PLAYLIST', 'TONE']);
